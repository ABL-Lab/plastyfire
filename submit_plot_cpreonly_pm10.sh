...
#SBATCH --job-name=cpreonly_pm10_plot
...
#SBATCH --output=/lustre06/project/6077694/dhuruva/plastyfire/cpreonly_pm10_plot_%j.log
...
python plot_stdp_ic_best.py --param-hash 21f3bec952eb \
    --label "c_pre-only fit on +/-10 only" --out stdp_cpreonly_pm10_bcl.png

echo
echo "################ c_pre-only original (bdbf06f915d0) ################"
python plot_stdp_ic_best.py --param-hash bdbf06f915d0 \
    --label "c_pre-only (orig, 3-point fit)" --out stdp_cpreonly_bcl.png
