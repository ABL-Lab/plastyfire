...
Individual datapoints not directly quoted in text in the respective publications were either digitised from figures or, whenever possible, downloaded from the authors' websites.

This data is provided here with the only goal of reproducing figures in our study.
The copyrights of the in vitro data belong to the authors of the original publications, as reported above.

To compare the in silico results on distance-dependent plasticity against in vitro data
[Sjostrom and Hausser 2006], we provide here a data downloader script (fetch_data.py).
The script generates the epsp_vs_dist_sjostrom_hausser_2006.csv file used in our 
notebooks for figures and analysis.
Alternatively the data can be manually downloaded from the corresponding author's
website at:
http://plasticity.muhc.mcgill.ca/DataPage/Sjostrom_2006_Fig_3/LTP_vs_loc.xls .
